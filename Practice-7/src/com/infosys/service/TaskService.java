...
public class TaskService {
    ...
    public void addTask(Scanner scanner) throws MaxTasksReachedException, InvalidTaskTitleException, InvalidTaskDescriptionException {
    ...
    public void updateTask(Scanner scanner) throws TaskNotFoundException, InvalidTaskTitleException, InvalidTaskDescriptionException {
    ...
    public void assignTask(Scanner scanner, User currentUser) throws TaskNotFoundException, AssignTaskToClientException, InvalidUsernameException {
    ...
    public void searchTask(Scanner scanner) throws TaskNotFoundException {
    ...
    public void markTaskAsCompleted(int taskId, User currentUser) throws TaskNotFoundException, UnauthorizedTaskCompletionException {
        Task task = taskDao.findTaskById(taskId);
