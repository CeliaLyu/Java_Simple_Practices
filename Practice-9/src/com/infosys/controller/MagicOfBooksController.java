...
public class MagicOfBooksController {
    ...
    private ExecutorService executorService = Executors.newSingleThreadExecutor(); // Executor service to handle user threads
    ...
    public void startApplication() {
        ...
        while (running) {
            ...
            switch (choice) {
                ...
                case 2: // User login
                    if (loginUser()) {
                        // Execute user-specific operations in a new thread
                        executorService.submit(this::userMenu);
                    }
                    break;
                case 3: // User logout
                    service.logoutUser();
        ...
        try {
            ...
            if (existingBook != null) {
                ...
                Book updatedBook = new Book(
                        newName.isEmpty() ? existingBook.getBookName() : newName,
